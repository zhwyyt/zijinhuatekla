...
class ClassificationFacade:
    ...
    def classify_part(self, part: NormalizedPart, hints: PartSpatialHints | None = None) -> PartRoleResult:
        return classify_part_role(part, hints)
...
def classify_part(part: NormalizedPart, hints: PartSpatialHints | None = None) -> PartRoleResult:
    return DEFAULT_FACADE.classify_part(part, hints)
