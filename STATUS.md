...
2026-09-20：`0.3.5-solid-cache` 已实测同一 289 根选择集。GetSolid 缓存命中 95350 / 实取 13851；截面样本仍为 5；与 0.3.3 重叠装配剖口、MainClass 均为 0 差异。回滚点 `rollback/exporter-0.3.3-index-once-20260920`。
